...
def load_model(model_file, params_file, use_gpu=False, use_mkl=True, mkl_thread_num=4):
    ...
    try:
        ...
        predictor = paddle_infer.create_paddle_predictor(config)
    return predictor
...
if __name__ == "__main__":
    ...
    while True:
        ...
        try:
            y_bboxes_output = predictor.get_output_handle(output_names[0])
            y_cls_output = predictor.get_output_handle(output_names[1])
        except AttributeError:
